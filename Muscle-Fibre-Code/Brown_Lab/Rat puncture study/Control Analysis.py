...
def ktrAnalysis(Data: pd.DataFrame = None, Filename: str = None, CSA: float = None, Graph: bool = False) -> tuple[float, float, float, pd.Series, pd.Series, float]:
   ...
   # def RStiffnessAnalysis(Data: pd.DataFrame, relax_stiff_time: int = relax_stiff_time):
    ...
    Peak_force = Data['Force'][250000:260000].mean()
    ...
    if Graph == True:
        ...
        plt.plot(Data['Time'][250000:260000], Data['Force'][250000:260000], color = 'blue', label = 'Peak')
...
excel_file_path = '/Users/joshbriar/Library/Mobile Documents/com~apple~CloudDocs/SF copies/C10MR.xlsx'
