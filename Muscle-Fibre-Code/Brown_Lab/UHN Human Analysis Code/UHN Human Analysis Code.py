...
def main():
    ...
    Directory = '/Users/keaton.briar/Desktop/Single Fibre Data/UHN Study/Data/Retest Data'
    ...
    for file in AllFiles:
        ...
        Stiffness, Strain, Modulus, ktr, GoodnessFit, Xmodel, Ymodel, ktrForce, Peak_force, RStiffness, RStrain, RModulus, ktr_delay = ktrAnalysis(Data = Data, Filename = os.path.basename(file), CSA=CSA, Graph = False)
...
excel_file_path = '/Users/keaton.briar/Desktop/Single Fibre Data/UHN Study/Data/Retest Data/output3.xlsx'
