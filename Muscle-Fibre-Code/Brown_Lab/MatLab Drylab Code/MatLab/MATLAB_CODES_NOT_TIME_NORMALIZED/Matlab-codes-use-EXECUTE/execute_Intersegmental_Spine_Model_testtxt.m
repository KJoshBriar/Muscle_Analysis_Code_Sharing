...
folder = 'C:\Cathrine\Pilot_STS_data\For_MATLAB\Test9';
...
% nameString = % '*.csv';
nameString = '*.txt'; % This will run all the trials for subject 'FT_13'
...
Intersegmental_Spine_Model(folder,'outFreq',100,'nameString', nameString);
%%
