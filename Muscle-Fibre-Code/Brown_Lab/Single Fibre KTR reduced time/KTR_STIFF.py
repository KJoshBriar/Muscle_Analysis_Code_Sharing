...
ktr_end_time:int = int(33 * sample_rate)
...
def ktrAnalysis(Data: pd.DataFrame = None, Filename: str = None, CSA: float = None, Graph: bool = False) -> tuple[float, float, float, pd.Series, pd.Series, float]:
    ...
    if Graph == True:
        ...
        plt.plot(Data['Time'][300000:301000], Data['Force'][300000:301000], color = 'Green', label = 'Active Stiffness')
        plt.plot(Data['Time'][600000:601000], Data['Force'][600000:601000], color = 'Orange', label = 'Passive Stiffness')
    ...
    return Stiffness, RStiffness, Modulus, RModulus, Modulus - RModulus, ktr, GoodnessFit, Peak_force/CSA, ((ktr_delay - ktr_start_time)-250000)/10
